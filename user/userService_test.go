	...
	tests := []struct {
	...
	}{
		{
			...
			expectedResult: []model.AssetWithValue{
				...
				{Item: "Total", Value: 100000.0, BookValue: 1000000.0},
			},
		},
		{
			...
			expectedResult: []model.AssetWithValue{
				...
				{Item: "Total", Value: 60000.0, BookValue: 1000000.0},
			},
		},
		{
			name:   "No assets",
			...
			expectedResult: []model.AssetWithValue{{Item: "Total", Value: 0.0, BookValue: 1000000.0}},
		},
	}
